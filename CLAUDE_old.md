...
React + TypeScript frontend for an async URL-crawling app. Backend is AWS Lambda-based; this doc gives the frontend enough context to be coded against the backend contract without needing the backend code present.
